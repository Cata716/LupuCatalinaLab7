using LupuCatalinaLab7.Models;
using Microsoft.Maui.Devices.Sensors;
using Plugin.LocalNotification;

namespace LupuCatalinaLab7;
...
public partial class ShopPage : ContentPage
{
    ...
    async void OnDeleteButtonClicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert("Eroare", "Magazinul nu poate fi sters", "OK");
            return;
        }

        bool answer = await DisplayAlert(
            "Confirmare stergere",
            $"Sigur doresti sa stergi magazinul '{shop.ShopName}'?",
            "DA, sterge",
            "NU, anuleaza");
        ...
        if (answer)
        {
            try
            {
                ...
                await DisplayAlert("Succes", "Magazinul a fost sters", "OK");
